...
fun LoginScreenView(
    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        ...
        val email = loginScreenViewModel.email.collectAsState().value
        val password = loginScreenViewModel.password.collectAsState().value
        ...
        Column(
            ...
            Column(
                ...
                uiState.messageErro?.let {
                    CustomAlert(
                        onDismissRequest = {},
                        onConfirmation = { loginScreenViewModel.reset() },
